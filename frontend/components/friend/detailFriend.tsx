      ...
      <div className="bg-white rounded-lg w-[400px] max-w-[90vw] shadow-xl h-[95%] overflow-auto">
        ...
        <div className="relative h-40 bg-white">
          <img
            ...
            alt="cover"
            className="w-full h-full object-scale-down border-b border-gray-200"
            onError={(e) => {
          ...
          <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2">
            <img
              ...
              alt="avatar"
              className="w-20 h-20 rounded-full border-1 border-gray-200 object-scale-down"
              onError={(e) => {
                e.currentTarget.onerror = null;
                e.currentTarget.src = "/images/default-avatar.jpg";
              }}  
