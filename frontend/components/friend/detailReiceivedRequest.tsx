...
export const DetailReceivedRequest = ({
  request,
  isOpen,
  onClose,
  onAccept,
  ...
  const goToChat = async () => {
    ...
    try {
      const res = await axiosInstance.post(`/api/chats`, {
        members: [request.sender.id, user.id],
      });
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg w-[400px] max-w-[90vw] shadow-xl h-[95%] overflow-auto">
        ...
        <div className="relative h-40 bg-white border-1 border-gray-100">
          <img
            src={request.sender.coverImage || "/images/default-avatar.jpg"}
            alt="cover"
          ...
          <div className="border-t pt-4">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-sm text-gray-600">
                {new Date(request.sender.createdAt).toLocaleDateString(
                  "en-US"
                ) || ""}
              </span>
            </div>
